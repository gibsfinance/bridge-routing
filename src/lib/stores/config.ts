  ...
  [Provider.TOKENSEX]: {
    [Chains.PLS]: {
      [Chains.BNB]: {
        ...
        destinationRouter: '0xCE12589cB48E579F3cA419b70096fb34235ff7CF',
        nativeRouter: '0x691775ef9d9AbE661ee3f10AF285E07DC04Ba0B6',
        feeManager: 'from',
        usesExtraParam: true,
        toHome: false,
        requiresDelivery: true,
    ...
    [Chains.BNB]: {
      [Chains.PLS]: {
        ...
        destinationRouter: '0x691775ef9d9AbE661ee3f10AF285E07DC04Ba0B6',
        feeManager: 'to',
        usesExtraParam: true,
        toHome: true,
        requiresDelivery: false,
